...
# Mirrors backend.cnn_agent._TRAINING_CONSTANT_CHANNELS. #99: prod set is
# now {17, 18, 19} (fast_rsi_1h, velocity_1h, vol_zscore — 1h-derived
# channels that emit constants from FeatureBuilder fallback). Ch 10/11/20/
# 24/25/26 are now real: 10/11 = candle-derived proxies (#46-A), 20 = OKX
# funding history (#86), 24/25 = RV prefix-lookback (#98), 26 = vol_sentiment.
DEFAULT_MASK = frozenset({17, 18, 19})
