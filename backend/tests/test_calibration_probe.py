...
class TestOutput:
    ...
    def test_returns_expected_keys(self):
        ...
        result = calibration_probe(
            samples, labels, ts,
            n_folds=3, embargo_hours=4, n_buckets=5,
            params={"max_depth": 3, "min_child_weight": 1, "subsample": 1.0},
            n_estimators=20, seed=0,
        )
        for k in ("fold_aucs", "mean_auc", "calibration_table",
                  "is_monotonic", "gate_passed", "gate_reason"):
...
class TestFeatureSetPassthrough:
    ...
    def test_v2_produces_more_feature_names_than_v1(self):
        ...
        r1 = calibration_probe(
            ...
            n_folds=3, embargo_hours=4, n_buckets=5,
            params={"max_depth": 3, "min_child_weight": 1, "subsample": 1.0},
            n_estimators=10, seed=0, feature_set="v1",
        )
        ...
        assert r2["feature_names"][270:] == [
            ...
            "xt_macd_sign_change_3", "xt_funding_x_trend",
        ]
