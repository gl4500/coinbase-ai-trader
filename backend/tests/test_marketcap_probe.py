...
class TestMarketcapRowsToLogGrid:
    ...
    def test_empty_rows_returns_empty(self):
        ...
        out = marketcap_rows_to_log_grid(
            [],
            hour_grid_ms=[1_700_000_000_000],
            lag_secs=_DAY,
        )
        assert out == {}
...
class TestSourceDispatch:
    ...
    @pytest.mark.asyncio
    async def test_coinpaprika_source_dispatches_to_paprika(self, monkeypatch, tmp_path):
        from tools import marketcap_probe as mp
        ...
        monkeypatch.setattr("services.coinpaprika_marketcap.fetch_marketcap_history", _spy)
