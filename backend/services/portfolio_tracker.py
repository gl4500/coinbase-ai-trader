...
class PortfolioTracker:
    ...
    async def sync(self) -> Dict:
        ...
        for acct in accounts:
            ...
            await database.get_product(product_id)
            ...
            product_orders = [
                o
                for o in orders
                if o["product_id"] == product_id and o["side"] == "BUY" and o.get("avg_fill_price")
            ]
            if product_orders:
                total_spent = sum(
                    (o.get("avg_fill_price", 0) * o.get("filled_size", 0)) for o in product_orders
                )
