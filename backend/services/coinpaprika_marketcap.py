...
async def fetch_marketcap_history(
    ...
    try:
        ...
        logger.warning("coinpaprika_marketcap history HTTP error pid=%s: %r", product_id, e)
        return []
...
async def fetch_supply_snapshot(
    ...
    try:
        ...
        logger.warning("coinpaprika_marketcap ticker HTTP error pid=%s: %r", product_id, e)
        return None
