...
These 12 rules govern HOW every agent works on this repo, regardless of which workflow (TDD, find-list-fix, etc.) is active. They override style preferences and are higher-priority than convenience.
